...
import com.example.chessmate.game.model.game.converter.ImportResult.ImportedGame
...
import com.example.chessmate.game.model.move.BoardMove.Ambiguity.AMBIGUOUS_FILE
import com.example.chessmate.game.model.move.BoardMove.Ambiguity.AMBIGUOUS_RANK
...
object PgnConverter : Converter {
    ...
    private fun extractData(text: String): PgnImportDataHolder {
        ...
        val tags = GameMetaInfo.createFromPGN().tags + tagsResults
